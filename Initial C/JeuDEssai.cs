...
namespace Initial_C
{
    class JeuDEssai
    {
        ...
        public static List<Véhicule> initializeVéhicules()
        {
            List<Véhicule> fleet = new List<Véhicule>();
            fleet.Add(new Voiture(1, "en marche", "Citroen", "C4", 42, 5));
            fleet.Add(new Voiture(2, "en réparation", "Renault", "Clio", 33, 6));
            fleet.Add(new Voiture(3, "en marche", "Fiat", "Panda", 69, 4));
            fleet.Add(new Camion(4, "en marche", "renault", "ork", 707, 1500, 260));
            fleet.Add(new Camion(5, "en marche", "daf", "euro", 10001, 1600, 250));
            fleet.Add(new Bateau(6, "en marche", "Plouf", "Petit Bato", 89, 4.60));
            fleet.Add(new Bateau(6, "en réparation", "Sunk'n'Norwegian", "Hello World!", 89, 4.60));
            return fleet;
        } 
    }
}
